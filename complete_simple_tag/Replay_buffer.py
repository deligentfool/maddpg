...
class Replay_buffer(object):
    def __init__(self,n_agent,n_action,n_self_feature,n_other_feature,capacity,batch_size):
        self.n_agent = n_agent
        self.n_action = n_action
        self.n_self_feature = n_self_feature
        self.n_other_feature = n_other_feature
        self.capacity = capacity
        self.batch_size = batch_size
        self.store_pos = 0
        self.counter = 0
        self.n_feature = self.n_other_feature + self.n_self_feature

        self.buf = np.zeros([self.capacity,(self.n_self_feature + self.n_other_feature) * 2 + self.n_action * self.n_agent + 1])
    ...
    def get_self_action(self,sample_index):
        return self.buf[sample_index,self.n_feature * 2:self.n_feature * 2 + self.n_action]
    
    def get_other_action(self,sample_index):
        return self.buf[sample_index,self.n_feature * 2 + self.n_action:-1]
    
    def get_all_action(self,sample_index):
        return self.buf[sample_index,self.n_feature * 2:-1]
    
    def get_reward(self,sample_index):
        return self.buf[sample_index,-1]
    
    def get_self_observation(self,sample_index):
        return self.buf[sample_index,:self.n_self_feature]
    
    def get_other_observation(self,sample_index):
        return self.buf[sample_index,self.n_self_feature:self.n_feature]
    
    def get_self_next_observation(self,sample_index):
        return self.buf[sample_index,self.n_feature:self.n_self_feature + self.n_feature]
    
    def get_other_next_observation(self,sample_index):
        return self.buf[sample_index,self.n_self_feature + self.n_feature:self.n_feature * 2]
    ...
    def get_all_next_observation(self,sample_index):
        return self.buf[sample_index,self.n_feature:self.n_feature * 2]
